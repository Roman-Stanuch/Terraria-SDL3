...
namespace Terraria
{
	static const ImVec4 DEFAULT_ITEM_BOX_COLOR = ImVec4(0.25f, 0.27f, 0.67f, 0.9f);
	static const ImVec4 DEFAULT_SELECTED_ITEM_BOX_COLOR = ImVec4(0.91f, 0.84f, 0.07f, 1.f);
